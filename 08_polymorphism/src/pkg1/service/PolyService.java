...
public class PolyService {
	...
	public void printObject(Object obj) {
		...
		// 전달 받은 주소의 객체가 Parent 객체인 경우
				...
				Parent p = (Parent)obj; // Parent 다운 캐스팅
	...
	public void test3() {
		...
		Parent p1 = new Parent(); // 부모가 부모를 참조. 부모 = 부모
		
		Child  c2 = new Child(); // 자식이 자식을 참조. 자식 = 자식
		
		Parent p3 = new Child(); // 부모가 자식을 참조. 부모 = 자식 (업캐스팅)
	...
	public void test4() {
		...
		// 참조 변수 타입 == Object
		// 대입 되는 객체 주소 == Parent, Child (자식 타입)
		// -> 업 캐스팅이 적용 된 상태!!
