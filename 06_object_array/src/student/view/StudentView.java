...
public class StudentView {
	...
	/**
	 * 이름을 입력 받아 service에 students 매열에서
	 * 같은 이름을 가진 학생의 객체를 얻어와 출력
	 */
	 ...
	 * 		"인덱스 범위가 올바르지 않습니다" (1)
	 * 
	 * 		정상범위 인덱스이지만 학생이 존재하지 않는 경우
	 * 		"해당 인덱스에 학생 정보가 존재하지 않습니다" (2)
	 * 
	 * 		정상 (3)
	 */
	private void updateIndex() {
		...
		/* 학생이 존재하는 경우 */
		// HTML, CSS, JS, Java 순서로 점수를 입력 : 100 40 60 70
		System.out.println("HTML, CSS, JS, Java 순서로 점수를 입력 : ");
	...
	/**
	 * 입력받은 index 번째 학생의 점수, 합계, 평균을 출력
	 * 
	 * 단, 정상 index 인지 확인
	 * 
	 * ex) 인덱스 입력 : 0
