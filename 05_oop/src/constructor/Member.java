...
public class Member {
	...
	public Member() {
		...
		// -> [ 주의 사항 ] : 반드시 생성자 첫 번째 줄에 작성!!
		this("ID","PW","NAME",100);
		
		
		
		
		// Member 객체가 생성 될 때 println() 구문을 수행
...
//	private void   method() {} // 접근제한자 다름 -> 중복 o
//	public String  method() {} // 반환형 다름 -> 중복 o
	 ...
	 *    전달받은 매개 변수에 따라 조금씩 동작이 달라야하는 경우
	 *    상황별로 메서드를 정의할 수 있음
	 *    
	 *  ex)
	 ...
	 *  ** 오버로딩 성립 조건 **
	 *  1) 메서드의 이름이 똑같아야 한다
	 *  2) 매개변수의 갯수, 자료형, 자료형 순서 중 하나라도 달라야 함
	 *  
	 *    
	 * */
	...
	public void method(int a) {} // 매개 변수 갯수가 다름
	public void method(int a, String b) {} // 매개 변수 갯수가 다름
	public void method(String b, int a) {} // 자료형 순서가 다름 
	public void method(String b, long a) {} // 자료형이 다름
