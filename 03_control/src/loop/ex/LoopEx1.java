...
public class LoopEx1 {
	...
	public void method3() {
		...
		int max = Math.max(a, b); // a,b중 작은 값
	...
	/**
	 * 1부터 100 사이의 정수 중 5의 배수의 핲, 개수 구하기 sum, count
	 */
	public void method4() {
		...
		System.out.printf("합계 : %d / 갯수 :%d ", sum, count);
	...
	/**
	 * 입력받은 단 출력하기 단, 입력 받은 단이 2~9 사이 숫자가 아니면 "잘못 입력 하셨습니다" 출력
	 */
	public void method6() {
