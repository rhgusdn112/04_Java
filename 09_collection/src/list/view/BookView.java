...
public class BookView {
	...
	private void addBook() {
		...
		// 입력 받은 정보를 묶어서 Service로 전달 할 수 있도록
		// BookDTO 객체를 생성
	 ...
	 * "[책제목] 책이 목록에서 제거되었습니다" 출력
	 * 
	 * 2) 일치하는 인덱스가 없다면
	 * "해당 인덱스에 존재하는 책이 없습니다"를 출력 
	 */
	private void removeBook() {
		System.out.println("\n @@@@@ 책 제거하기 @@@@@ \n");
		
		System.out.print("제거할 책 인덱스 번호 입력 : ");
		int index = sc.nextInt();
		...
		System.out.printf("[%s] 책이 목록에서 제거되었습니다.\n",
							result);
	...
	private void updateBook() {
		...
		// 인덱스가 일치하는 요소에 BookDTO(참조 주소)를 반환 받기
		
		// ex) index 가 0인 경우
		// BookService bookList.get(0) 에 저장된 주소와
		// 아래에 있는 book 에 저장된 주소가 "같음"
		BookDTO book = service.selectIndex(index);
		...
		// book 이 참조하는 BookDTO 의 가격을 newPrice로 수정
