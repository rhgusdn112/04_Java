...
public class JavaApiService {
	 ...
	 * [String 객체를 생성하는 방법]
	 * 
	 * 1) String s1 = "Hello"; // 리터럴표기법을 이용한 방법
	 ...
	 * - String 은 기본적으로 값이 변하는 것이 불가능하다
	 * 
...
//		String s2 = s1;
	...
	public void test4() {
		...
		// 3) String 문자열.replace("바꿀 대상 문자열", "바꿀 문자열")
		// - 문자열 변경
