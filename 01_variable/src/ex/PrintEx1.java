...
public class PrintEx1 {
	...
	public static void main(String[] args) {
		...
		/*
		 * System.out == 지정된 출력용 화면 == 이클립스는 console 창 System.out.print(출력내용); - () 내의
		 * 값을 console에 출력 -> 줄이 바뀌지 않고 이후 출력도 오른쪽에 이어서 작성
		 * 
		 * 
		 * System.out.println(출력내용); - () 내의 값을 console에 출력 + 줄바꿈
		 * 
		 * 
		 * System.out.printf("템플릿", 사용될 변수||값...);
		 * 
		 * - 정해진 형식(템플릿)에 맞는 문자열을 출력하는 구문 - 템플릿 문자열 중간에 작성된 '%' 패턴 구문에 "사용될 변수||값"을 순서대로
		 * 대입
		 * 
		 * (JS의 ``(백틱) 구문과 같은 템플릿 문자열)
		 * 
		 * ex) [JS] const name = "홍길동"; console.log( `나는 ${name} 입니다` );
		 * 
		...
		String name = "홍길동"; // (참조형)
		int age = 25; // (정수 기본형, 4byte)
		double height = 212.5; // (실수 기본형, 8byte)
		char gender = '남'; // (문자형, 2byte)
		boolean javaStudy = true; // 논리형(1byte)

		// 홍길동은 25세 남성으로 키는 212.5cm 이고 자바공부 여부 : true
