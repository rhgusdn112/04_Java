...
public class VariableEx1 {
	...
	public static void main(String[] args) {
		...
		/*
		 * 자료형* (Data Type) - 변수에 저장되는 값의 종류/크기
		 * 
		 * [Java 기본 자료형 8가지]
		 * 
		 * -논리형- boolean (1byte) - true / false
		 * 
		 * -정수형- byte (1byte) short (2byte) int (4byte) - 정수 기본형(123 -> 정수로 인식) long
		 * (8byte) - 숫자 뒤에 l 또는 L 붙임(123L)
		 * 
		 * -실수형- float (4byte) - 숫자 뒤에 f 또는 F 붙임(3.14f) double (8byte) - 실수 기본형
		 * 
		 * -문자형- char (2byte) - 문자 하나를 의미, 'A'
		 * 
		 */

		// 변수 선언 : 메모리에 값을 저장할 공간을 만듦(== 할당)

		int num1; // 메모리에 int형 데이터를 저장하기 위한
					// 저장하기 위한 공간 4byte를 할당하고
					// 변수 이름을 num1 이라고 지정
		// 자바는 초기화(처음 값 대입) 되지 않은
		// 지역 변수를 출력, 연산 할 수 없다(대입 연산만 가능)
		...
		System.out.println("---------------------------------------"); // 값이 대입되면 오류 X
		...
		// JS에서는 true == 1 비교가 가능했지만, Java는 안됨
		// 왜? 자료형이 같지 않아서 비교 불가
		 ...
		 * byte크기가 float의 2배라서 double이 아님!!
		 * 
		 * 정확도가 2배
		 * == 소수점 표현 자릿수가 2배라서 double
		 */
