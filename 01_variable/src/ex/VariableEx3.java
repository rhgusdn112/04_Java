...
public class VariableEx3 {
	 ...
	 */
		...
		System.out.println("고의 번호: " + (int)'고'); // 44256
		System.out.println("현의 번호: " + (int)'현'); // 54788
		System.out.println("우의 번호: " + (int)'우'); // 50864
		...
		System.out.println("max : " + (max+1)); // -2147483648
